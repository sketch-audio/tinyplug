function(make_auv3_plugin USER_TARGET)
    ...
    if(TINY_AUV3_SIZE_TAG)
        set(_size_strings "")
        foreach(_size_tag IN LISTS TINY_AUV3_SIZE_TAG)
            string(STRIP "${_size_tag}" _size_tag)
            list(APPEND _size_strings "<string>${_size_tag}</string>")
        endforeach()
        string(JOIN "\n                        " TINY_AUV3_TAGS ${_size_strings})
    endif()
    ...
    target_link_libraries(${CORE_TARGET} PRIVATE ${TINY_DSP_LIB})
    ...
    target_link_libraries(${APP_TARGET} PRIVATE ${TINY_DSP_LIB})
        endif()
        configure_file(
